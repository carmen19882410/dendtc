...
#define nrn_init _nrn_init__itGHK
#define _nrn_initial _nrn_initial__itGHK
#define nrn_cur _nrn_cur__itGHK
#define _nrn_current _nrn_current__itGHK
#define nrn_jacob _nrn_jacob__itGHK
#define nrn_state _nrn_state__itGHK
#define _net_receive _net_receive__itGHK 
#define castate castate__itGHK 
#define evaluate_fct evaluate_fct__itGHK 
...
extern Memb_func* memb_func;
 ...
 "setdata_itGHK", _hoc_setdata,
 "efun_itGHK", _hoc_efun,
 "evaluate_fct_itGHK", _hoc_evaluate_fct,
 "ghk_itGHK", _hoc_ghk,
 "nongat_itGHK", _hoc_nongat,
 0, 0
};
#define efun efun_itGHK
#define ghk ghk_itGHK
#define nongat nongat_itGHK
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 itGHK /home/ocnc/Downloads/dendtc/x86_64/ITGHK.mod\n");
...
static int  evaluate_fct ( _threadargsprotocomma_ double _lv ) {
   m_inf = 1.0 / ( 1.0 + exp ( - ( _lv + shift + actshift + 57.0 ) / 6.2 ) ) ;
   h_inf = 1.0 / ( 1.0 + exp ( ( _lv + shift + 81.0 ) / 4.0 ) ) ;
...
double nongat ( _threadargsprotocomma_ double _lv , double _lcai , double _lcao ) {
   double _lnongat;
 _lnongat = pcabar * ghk ( _threadargscomma_ _lv , _lcai , _lcao ) ;
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = pcabar * m * m * h * ghk ( _threadargscomma_ v , cai , cao ) ;
   }
 _current += ica;
